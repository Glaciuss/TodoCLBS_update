...
class Update : Fragment() {
    ...
    private fun updateDataToDataBase() {
        ...
        if(!inputCheck(updateT,updateSub,updateDate)){
            val taskUpdate = Task(argsUpdate.parcelUpdate.id,updateT,updateSub,updateDate,argsUpdate.parcelUpdate.check)
            ...
            val query = UserViewModel.FirebaseURL.databaseReference.orderByChild("title").equalTo(argsUpdate.parcelUpdate.title.toString())
